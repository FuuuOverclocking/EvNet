import { ElementType, Node, Port, VirtualNode } from 'core/types';

export { resolveValueAlongPath } from 'core/utilities/resolve-value-along-path';
export { SortedPriorityQueue } from 'core/utilities/sorted-priority-queue';
...
export function getSymbol(fallback: 'string' | 'object' = 'string'): symbol {
   return hasSymbol
      ? Symbol()
      : fallback === 'string'
      ? (randomString(32) as any)
      : {};
}
